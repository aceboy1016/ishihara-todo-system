...
export function generateInitialTasks() {
  ...
  },
  {
    id: 14,
    category: 'topform' as const,
    title: '【毎月5日】小口&レシートを笹間さんへ郵送（なければ省略）',
    priority: 'B' as const,
    energy: 'low' as const,
    completed: false,
    completedDate: null,
  ...
  // 毎月25日の業務
  {
    ...
    estimatedHours: 0.5,
    notes: 'TOPFORM業務',
    scheduledDate: generateMonthlyTaskDate(25),
    isRecurring: true,
    recurringType: 'monthly' as const,
    recurringInterval: 1,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    id: 53,
    category: 'topform' as const,
    title: '【毎月25日】HALLEL 半蔵門 枠抑える（月〜金 21:00〜以降、土日 18:00〜以降）',
    priority: 'A' as const,
    energy: 'low' as const,
    completed: false,
    completedDate: null,
  ...
  // 毎月末日の業務
  {
    ...
    estimatedHours: 0.5,
    notes: 'TOPFORM業務',
    scheduledDate: generateMonthlyTaskDate(28),
    isRecurring: true,
    recurringType: 'monthly' as const,
    recurringInterval: 1,
    createdAt: new Date().toISOString(),
  ...
  // 今週〜来週の優先タスク
  {
    id: 60,
    category: 'topform' as const,
    title: '血糖値プログラム：コンテンツ制作の続行',
    priority: 'A' as const,
    energy: 'high' as const,
    completed: false,
    completedDate: null,
    estimatedHours: 3,
    notes: '血糖値改善プログラムのコンテンツ制作を継続する',
  ...
  },
  {
    id: 61,
    category: 'topform' as const,
    title: '血糖値プログラム：動画コンテンツの作成',
    priority: 'S' as const,
    energy: 'high' as const,
    completed: false,
    completedDate: null,
    estimatedHours: 4,
    notes: 'ボトルネック。最優先で着手すること',
  ...
  },
  {
    id: 65,
    category: 'topform' as const,
    title: '結婚式：乾杯挨拶を依頼する上司への連絡',
    priority: 'S' as const,
    energy: 'low' as const,
    completed: false,
    completedDate: null,
    estimatedHours: 0.5,
    notes: '期日が迫っているため最優先で連絡すること',
